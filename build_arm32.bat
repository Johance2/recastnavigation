...
cmake -A ARM ../ -DCMAKE_SYSTEM_VERSION=%ANDROID_API% -DCMAKE_ANDROID_ARCH_ABI=%ANDROID_ABI% -DCMAKE_ANDROID_NDK=%NDK_ROOT% -DCMAKE_SYSTEM_NAME=Android -DCMAKE_ANDROID_STANDALONE_TOOLCHAIN=%TOOLCHAIN%
cmake -A ARM ../ -DCMAKE_SYSTEM_VERSION=%ANDROID_API% -DCMAKE_ANDROID_ARCH_ABI=%ANDROID_ABI% -DCMAKE_ANDROID_NDK=%NDK_ROOT% -DCMAKE_SYSTEM_NAME=Android -DCMAKE_ANDROID_STANDALONE_TOOLCHAIN=%TOOLCHAIN%
